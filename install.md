...
You are advised to disable Secure Boot and make sure UEFI is set to Enabled in your BIOS. See [here](start.md#secboot) for more information before proceeding if you need any more clarification.
